...
View available and recommend positions 


View research position details 

Apply for research position 


View application status and reference update


Withdraw “pending” applications


Filter research opportunities
...
Create undergraduate research position


Edit undergraduate research position


Delete undergraduate research position


View student application profiles


View student profile for faculty
...
Edit the predefined list of values from which user can select


Edit or delete undergraduate research positions


Approve/decline student reference request


Receive student reference notification
